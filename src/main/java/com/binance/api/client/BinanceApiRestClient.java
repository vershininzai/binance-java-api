...
public interface BinanceApiRestClient {
    ...
    AccountSnapshot getAccountSnapshot(AccountSnapshotType type,
                                       Long startTime,
                                       Long endTime,
                                       Integer limit,
                                       Long recvWindow,
    ...
    List<WithdrawHistory2> getWithdrawHistory(
            String coin,
            Integer status,
            Integer offset,
            Integer limit,
    ...
    List<DepositHistory2> getDepositHistory(
            String coin,
            Integer status,
            Integer offset,
            Integer limit,
    ...
    List<CapitalConfigAll> getCapitalConfigAll(Long recvWindow, Long timestamp);

    SpotSummary getSpotSummary(Long recvWindow, Long timestamp);

    List<AllOrderDto> getAllOrders(Long recvWindow, Long timestamp);
