...
import com.binance.api.client.impl.BinanceFapiRestClientImpl;
...
public class BinanceApiClientFactory {
     ...
     * Creates a new synchronous/blocking REST client.
     */
    public BinanceFapiRestClient newFapiRestClient() {
        return new BinanceFapiRestClientImpl(apiKey, secret);
    }
