...
import com.binance.api.client.domain.account.AccountSnapshot;
import com.binance.api.client.domain.account.AccountSnapshotType;
import com.binance.api.client.domain.account.AllOrderDto;
import com.binance.api.client.domain.account.CapitalConfigAll;
import com.binance.api.client.domain.account.DepositAddress;
import com.binance.api.client.domain.account.DepositHistory;
import com.binance.api.client.domain.account.DepositHistory2;
import com.binance.api.client.domain.account.NewOrder;
import com.binance.api.client.domain.account.NewOrderResponse;
import com.binance.api.client.domain.account.Order;
import com.binance.api.client.domain.account.SpotSummary;
import com.binance.api.client.domain.account.Trade;
import com.binance.api.client.domain.account.TradeHistoryItem;
import com.binance.api.client.domain.account.WithdrawHistory;
import com.binance.api.client.domain.account.WithdrawHistory2;
...
public class BinanceApiRestClientImpl implements BinanceApiRestClient {
    ...
    @Override
    public AccountSnapshot getAccountSnapshot(AccountSnapshotType type,
                                              Long startTime,
                                              Long endTime,
                                              Integer limit,
                                              Long recvWindow,
    ...
    @Override
    public List<AllOrderDto> getAllOrders(Long recvWindow, Long timestamp) {
        return executeSync(binanceApiService.getAllOrders(recvWindow, timestamp));
    }

    @Override
    public SpotSummary getSpotSummary(Long recvWindow, Long timestamp) {
        return executeSync(binanceApiService.getSpotSummary(recvWindow, timestamp));
    }

    @Override
    public List<CapitalConfigAll> getCapitalConfigAll(Long recvWindow, Long timestamp) {
        return executeSync(binanceApiService.getCapitalConfigAll(recvWindow, timestamp));
    }
    ...
    @Override
    public List<WithdrawHistory2> getWithdrawHistory(
            String coin,
            Integer status,
            Integer offset,
            Integer limit,
            ...
            Long recvWindow,
            Long timestamp) {
        return executeSync(binanceApiService.getWithdrawHistory(coin, status, offset, limit, startTime, endTime, recvWindow, timestamp));
    }

    @Override
    public List<DepositHistory2> getDepositHistory(
            String coin,
            Integer status,
            Integer offset,
            Integer limit,
            ...
            Long recvWindow,
            Long timestamp) {
        return executeSync(binanceApiService.getDepositHistory(coin, status, offset, limit, startTime, endTime, recvWindow, timestamp));
    }
